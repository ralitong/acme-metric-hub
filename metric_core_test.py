...
class TestMetricCore(unittest.TestCase):
    ...
    def test_storing_of_batch_process_data(self):
        ...
        self.assertEqual(self.metric_core.storage[server_name][0]['start_time'], start_time)
        self.assertEqual(self.metric_core.storage[server_name][0]['end_time'], end_time)
    ...
    def test_storing_more_than_one_data_same_server(self):
        ...
        data = self.metric_core.storage[server_name]
    ...
    def test_storing_more_than_one_data_different_server(self):
        ...
        server_one_data = self.metric_core.storage[server_one]
        server_two_data = self.metric_core.storage[server_two]
